...
class SpinningLinesPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(SpinningLinesPainter oldDelegate) => oldDelegate.rotateValue != rotateValue || oldDelegate.lineWidth != lineWidth || oldDelegate.itemCount != itemCount || oldDelegate._linePaint != _linePaint;
}
